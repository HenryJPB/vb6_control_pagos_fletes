...
Private Sub Relacion_Pago_Fletes_Click()
  Comando = "rwrun60 report=" & CurrentDir & "Control_Pago_Fletes_v2.rdf userid=" & CurrentUser
  ExeComando = Shell(Comando, vbNormalFocus)
End Sub

Private Sub Dsitribucion_Fletes_Click()
  Comando = "rwrun60 report=" & CurrentDir & "Distribucion_Fletes_v2.rdf userid=" & CurrentUser
  ExeComando = Shell(Comando, vbNormalFocus)
End Sub
